        ...
        <div className="flex shrink-0 w-full justify-center my-[18px]">
          <div className="flex justify-between w-[250px] min-w-[250px]">
            <Link to={paths.home()} aria-label="Home" className="flex items-center gap-x-2">
              ...
              />
              <span className={`text-white font-bold text-2xl tracking-wide transition-opacity duration-500 ${showSidebar ? "opacity-100" : "opacity-0"}`}>
                Copilot
              </span>
            </Link>
            {canToggleSidebar && (
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-center flex-grow gap-x-2">
          ...
          />
          <span className="text-white font-bold text-2xl tracking-wide">Copilot</span>
        </div>
